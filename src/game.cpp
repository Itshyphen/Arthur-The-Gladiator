...
void game::start(sf::RenderWindow &window)
{
    ...
    CircleShape bombBox(35); //No. of bombs
	bombBox.setFillColor(Color::Black);
	bombBox.setOutlineThickness(2);
	...
	while (window.isOpen())
	{
        ...
        //bombs
		b.setPosition(935, 385);
        bb.setPosition(945, 408);
		window.draw(b);

		//to convert int to string
		stringstream smove, slife,sbomb;
